...
//#define DEFENCE_BOT_CODE
    ...
    #define DEFENCE_ACCELERATION_MULTIPLIER 2 //smaller the value, the acceleration is slower(speeds up or slows down slower)
...
#define X_AXIS_LIDARS_POSITIONAL_OFFSET 6.865  // from front of lidar to centre of bot
