...
class Sensorfusion {
   public:
    ...
    void updateSensorValues(int flpwm, int frpwm, int blpwm, int brpwm, int frontTof, int backTof,
                            int leftTof, int rightTof, int x_camera, int y_camera);
    void updateConstants(double frontVariance, double backVariance, double leftVariance,
