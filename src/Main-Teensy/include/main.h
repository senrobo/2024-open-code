...
struct LightArray {
    ...
    float c = 10;
    float LDRThresholds[LDRPINCOUNT]{
        779.60, 784.70, 770.00, 761.20, 769.40, 720.90, 783.60, 784.80, 743.90,
        784.50, 787.00, 694.00, 740.10, 732.20, 784.10, 802.20, 782.30, 787.50,
        782.60, 775.60, 776.30, 782.80, 801.20, 793.90, 803.60, 800.90, 804.90,
        793.50, 790.80, 798.90, 787.70, 784.30, 777.80, 797.10, 778.90, 779.70};
    // 26,27,29,13
    double maxRecordedValue[LDRPINCOUNT]{
