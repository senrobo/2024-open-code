...
struct LightArray {
    ...
    float c = 10;
    float LDRThresholds[LDRPINCOUNT]{
        767.20, 772.90, 758.00, 746.40, 755.80, 696.30, 773.20, 775.60, 725.30,
        775.50, 777.00, 680.00, 718.70, 709.40, 774.70, 793.40, 772.10, 778.50,
        770.20, 763.20, 764.10, 771.60, 792.40, 785.30, 795.20, 792.30, 796.30,
        784.50, 781.60, 790.30, 777.90, 774.10, 766.60, 787.70, 768.30, 767.90};
    // 26,27,29,13
    double maxRecordedValue[LDRPINCOUNT]{
