...
struct LightArray {
    ...
    // 26,27,29,13
    double maxRecordedValue[LDRPINCOUNT]{
        896, 895, 889, 878, 879, 868, 879, 879, 868, 878, 882, 796,
        871, 872, 880, 891, 889, 892, 900, 897, 893, 904, 912, 905,
        915, 911, 916, 913, 907, 906, 904, 901, 902, 912, 891, 896};

    double minRecordedValue[LDRPINCOUNT]{
        875, 878, 862, 852, 857, 840, 858, 854, 842, 855, 861, 775,
        845, 840, 851, 871, 866, 868, 878, 872, 870, 885, 890, 885,
        898, 888, 897, 885, 886, 890, 883, 878, 879, 894, 868, 871};
